    ...
    return (
      <SidebarNavSlim
        ...
        logo={
          ...
          >
            <div className="flex size-8 items-center justify-center rounded-full bg-primary text-primary-fg text-sm font-bold select-none group-hover:opacity-0 transition-opacity">
              M
            </div>
            <ChevronsRight className="size-5 text-fg-tertiary absolute opacity-0 group-hover:opacity-100 transition-opacity" />
          </button>
        }
        items={[
      ...
      logo={
        <div className="flex w-full items-center justify-between">
          ...
          <button
            type="button"
            onClick={onToggle}
            className="flex size-8 items-center justify-center rounded-lg text-fg-tertiary hover:bg-bg-secondary hover:text-fg transition-colors"
