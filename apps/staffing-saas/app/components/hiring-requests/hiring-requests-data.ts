...
export const HIRING_REQUESTS: HiringRequestRecord[] = [
  {
    ...
    timeline: [
      { id: "t-1", at: "12/05/2026", action: "Khách hàng tạo yêu cầu", actor: "Highlands Commerce" },
  ...
  },
  {
    ...
    timeline: [
      { id: "t-1", at: "10/05/2026", action: "Tạo hiring request", actor: "GoMart Distribution" },
  ...
  },
  {
    ...
    timeline: [
      { id: "t-1", at: "08/05/2026", action: "Tạo hiring request", actor: "Medistar Clinic" },
  ...
  },
  {
    ...
    timeline: [
      { id: "t-1", at: "05/05/2026", action: "Tạo hiring request", actor: "GoMart Distribution" },
