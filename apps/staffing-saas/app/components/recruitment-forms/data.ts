// Mock dữ liệu khu vực / công ty / lựa chọn cho form tuyển dụng.
// Copy có chọn lọc từ worker-app referral data — danh sách công ty là PLACEHOLDER
// (monogram), không phải logo thật. Khi nối backend: thay PROVINCES /
// ACTIVE_BY_PROVINCE bằng API.
...
export const LICENSES = ["Chưa có", "A1", "A2", "B1", "B2", "C", "D", "E", "F"] as const;
...
/** Brand mặc định cho form mới — Untitled UI purple. */
export const DEFAULT_BRAND = "#7f56d9";
