...
import { CTV, colorName, FORM_COLORS } from "../../data/ctv-referral";
...
export function ColorPicker({ color, onChange }: ColorPickerProps) {
  const previewHref = `/gioi-thieu/${CTV.slug}?brand=${encodeURIComponent(color)}`;
        ...
        <CardContent className="flex gap-4 p-4">
          <div className="flex min-w-0 flex-1 flex-col">
            <p className="text-[13px] leading-relaxed text-fg-tertiary">
              Chọn màu thương hiệu cho trang đăng ký bạn gửi đi — áp dụng cho cả mã QR &amp; ảnh chia sẻ.
            </p>
