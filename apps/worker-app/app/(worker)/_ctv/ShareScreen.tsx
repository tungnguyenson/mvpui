...
const CHANNELS: Channel[] = [
	{
		...
		label: "Zalo",
		background: "#0068FF",
		path: "M12 2C6.2 2 1.5 6.03 1.5 11c0 2.77 1.46 5.25 3.76 6.92-.15 1.2-.66 2.4-1.5 3.36-.27.31-.04.8.37.73 1.96-.34 3.6-1.13 4.74-2.02 1.13.32 2.34.49 3.63.49 5.8 0 10.5-4.03 10.5-9S17.8 2 12 2z",
	},
	{
		id: "fb",
		label: "Facebook",
	...
	},
	{
		...
		label: "TikTok",
		background: "#010101",
		path: "M16.44 0c.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z",
	},
	{
		id: "mess",
		label: "Messenger",
		background: "linear-gradient(135deg,#00B2FF,#006AFF)",
		path: "M12 2C6.3 2 2 6.2 2 11.7c0 2.9 1.2 5.4 3.1 7.1.2.1.3.3.3.6l.1 1.8c0 .5.6.9 1.1.7l2-.9c.2-.1.4-.1.6-.1 1 .3 2 .4 3.1.4 5.7 0 10-4.2 10-9.7S17.7 2 12 2zm6 7.5l-2.9 4.6c-.5.7-1.4.9-2.1.4l-2.3-1.7c-.2-.2-.5-.2-.8 0l-3.1 2.4c-.4.3-.9-.2-.7-.6l2.9-4.6c.5-.7 1.4-.9 2.1-.4l2.3 1.7c.2.2.5.2.8 0l3.1-2.4c.4-.3.9.2.7.6z",
	},
];
	...
	return (
		<div className="ctv-referral" style={{ ["--bp" as string]: color }}>
			...
			<div className="relative z-10 -mt-14.5 flex flex-col gap-3.5 px-4 pb-6 lg:mx-auto lg:max-w-4xl lg:grid lg:grid-cols-2 lg:items-start lg:gap-5 lg:px-8">
					...
					<CardContent className="flex flex-col items-center gap-4 p-[18px]">
							...
							<div className="flex w-full flex-col items-center">
								...
								<div className="mt-4 flex w-full gap-2">
									<Button
										...
										iconLeading={Share2}
										onClick={() => nativeShareOr("ứng dụng")}
									>
										Chia sẻ
									</Button>
									<Button
						...
						<div className="flex w-full items-center gap-2.5">
							...
							<Button
								...
								className={
									copied
										? "bg-success-600! text-white! ring-success-600! hover:bg-success-600!"
										: undefined
								}
							>
				...
				{/* Right column on desktop: form-type + color picker + stats + reward teaser */}
				<div className="contents lg:flex lg:flex-col lg:gap-3.5">
					...
					>
						...
						<span className="flex-1">
							...
							<span className="block text-[18px] font-bold text-fg">
								{money(EARNINGS.thisMonth)}
							</span>
						</span>
...
function StatCard({
	...
	const valueColor =
		tone === "success" ? "text-fg-success" : tone === "brand" ? "text-fg-brand" : "text-fg";
	return (
...
function SharePoster({ brand }: { brand: string }) {
	return (
		<div className="ctv-poster" style={{ ["--bp" as string]: brand }}>
			...
			<div className="psub">
				Quét mã QR hoặc bấm vào link bên dưới để đăng ký. Mình hỗ trợ bạn xếp việc tận nơi.
			</div>
			<div className="pqr">
				<QRCode
					size="md"
					value={CTV.fullLink}
					options={{ ...QR_OPTIONS, width: 132, height: 132 }}
					className="border-0 p-0"
				/>
			</div>
			<div className="pfoot">
