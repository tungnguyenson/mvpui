...
import { Avatar, ButtonUtility } from "@mvp-ui/ui";
  ...
  return (
    <div className="min-h-dvh bg-bg-secondary">
      <div className="mx-auto flex min-h-dvh w-full max-w-md flex-col bg-bg md:border-x md:border-border-secondary md:shadow-sm">
        ...
        {/* Bottom navigation */}
        <nav className="sticky bottom-0 z-20 grid grid-cols-2 border-t border-border-secondary bg-bg/95 pb-[env(safe-area-inset-bottom)] backdrop-blur-sm">
          {NAV_ITEMS.map((item) => {
