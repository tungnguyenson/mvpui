...
export function WorkerShell({ children }: { children: ReactNode }) {
    ...
    <div className="flex flex-col gap-2">
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          <span className="block truncate text-sm font-semibold text-fg">{CURRENT_WORKER.name}</span>
          <span className="block truncate text-xs text-fg-tertiary">Mã CTV · {CURRENT_WORKER.id}</span>
        </span>
      </Link>
  ...
  return (
    <div className="min-h-dvh bg-bg-secondary lg:flex">
