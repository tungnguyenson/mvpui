 ...
 * Path: components/shared-assets/background-patterns/circle.tsx
 *
...
const lg = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg width="768" height="768" viewBox="0 0 768 768" fill="none" {...props} className={cn("text-border-secondary", props.className)}>
...
const md = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg width="480" height="480" viewBox="0 0 480 480" fill="none" {...props} className={cn("text-border-secondary", props.className)}>
...
const sm = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg width="336" height="336" viewBox="0 0 336 336" fill="none" {...props} className={cn("text-border-secondary", props.className)}>
