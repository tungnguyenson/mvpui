 ...
 * Path: components/shared-assets/background-patterns/grid.tsx
 *
...
const md = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg width="480" height="480" viewBox="0 0 480 480" {...props} fill="none" className={cn("text-border-secondary", props.className)}>
...
const sm = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg width="336" height="336" viewBox="0 0 336 336" {...props} fill="none" className={cn("text-border-secondary", props.className)}>
