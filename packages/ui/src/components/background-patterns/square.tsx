 ...
 * Path: components/shared-assets/background-patterns/square.tsx
 *
...
const lg = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg width="910" height="910" viewBox="0 0 910 910" fill="none" {...props} className={cn("text-border-secondary", props.className)}>
