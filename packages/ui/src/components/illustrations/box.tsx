 ...
 * Path: components/shared-assets/illustrations/box.tsx
 *
...
export const sm = ({
    ...
    return (
        <div {...otherProps} className={cn("relative h-31.5 w-38", className)}>
            <svg viewBox="0 0 152 126" fill="none" className={cn("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="76" cy="60" r="52" className="fill-bg-secondary" />
                <circle cx="21" cy="27" r="5" className="fill-bg-secondary" />
                <circle cx="18" cy="111" r="7" className="fill-bg-secondary" />
                <circle cx="145" cy="43" r="7" className="fill-bg-secondary" />
                <circle cx="134" cy="16" r="4" className="fill-bg-secondary" />
                <g filter="url(#box-shadow-sm)">
                    <path d="M76.0006 92.1898L118 73.5312V20.375L76.3298 2L34 20.375V73.5312L76.0006 92.1898Z" className="fill-bg" />
                    <path
                    ...
                    />
                    <path d="M76 38.0629V92.2344L34 73.5312V20.375L76 38.0629Z" className="fill-bg-tertiary" />
                    <path d="M76.0008 38.0938V92.2344L118 73.5312V20.375L76.0008 38.0938Z" fill="url(#box-gradient-sm)" />
                    <path d="M76 38.0938L118 20.375L76.3298 2L34 20.375L76 38.0938Z" className="fill-bg" />
                    <path
                ...
                <defs>
                    ...
                    <linearGradient id="box-gradient-sm" x1="97" y1="20.375" x2="128.011" y2="74.9366" gradientUnits="userSpaceOnUse">
                        ...
                        <stop offset="1" stopColor="currentColor" className="text-bg-tertiary" />
                    </linearGradient>
                </defs>
            </svg>
...
export const md = ({
    ...
    return (
        <div {...otherProps} className={cn("relative h-37 w-43", className)}>
            <svg viewBox="0 0 172 148" fill="none" className={cn("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="86" cy="74" r="64" className="fill-bg-secondary" />
                <circle cx="20" cy="30" r="6" className="fill-bg-secondary" />
                <circle cx="17" cy="122" r="8" className="fill-bg-secondary" />
                <circle cx="160" cy="46" r="8" className="fill-bg-secondary" />
                <circle cx="149" cy="19" r="5" className="fill-bg-secondary" />
                <g filter="url(#box-shadow-md)">
                    <path d="M86.0007 113.664L138 90.5625V24.75L86.4084 2L34 24.75V90.5625L86.0007 113.664Z" className="fill-bg" />
                    <path
                        ...
                        className="stroke-border-secondary"
                    />
                    <path d="M86 46.6493V113.719L34 90.5625V24.75L86 46.6493Z" className="fill-bg-tertiary" />
                    <path d="M86.001 46.6875V113.719L138 90.5625V24.75L86.001 46.6875Z" fill="url(#box-gradient-md)" />
                    <path d="M86 46.6875L138 24.75L86.4084 2L34 24.75L86 46.6875Z" className="fill-bg" />
                    <path
...
export const lg = ({
    ...
    return (
        <div {...otherProps} className={cn("relative h-45.25 w-55", className)}>
            <svg viewBox="0 0 220 181" fill="none" className={cn("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="110" cy="90" r="80" className="fill-bg-secondary" />
                <circle cx="26" cy="30" r="8" className="fill-bg-secondary" />
                <circle cx="198" cy="136" r="6" className="fill-bg-secondary" />
                <circle cx="25" cy="148" r="10" className="fill-bg-secondary" />
                <circle cx="210" cy="56" r="10" className="fill-bg-secondary" />
                <circle cx="191" cy="21" r="7" className="fill-bg-secondary" />
                <g filter="url(#box-shadow-lg)">
                    <path d="M110.001 139.432L174 111V30L110.503 2L46 30V111L110.001 139.432Z" className="fill-bg" />
                    <path
                        ...
                        className="stroke-border-secondary"
                    />
                    <path d="M110 56.9531V139.5L46 111V30.0001L110 56.9531Z" className="fill-bg-tertiary" />
                    <path d="M110.001 57V139.5L174 111V30L110.001 57Z" fill="url(#box-gradient-lg)" />
                    <path d="M110 57L174 30L110.503 2L46 30L110 57Z" className="fill-bg" />
                    <path
