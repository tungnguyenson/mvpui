 ...
 * Path: components/shared-assets/illustrations/credit-card.tsx
 *
...
export const sm = ({
    ...
    return (
        <div {...otherProps} className={cn("relative h-29.5 w-38", className)}>
            <svg viewBox="0 0 152 118" fill="none" className={cn("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="21" cy="5" r="5" className="fill-bg-secondary" />
                <circle cx="18" cy="109" r="7" className="fill-bg-secondary" />
                <circle cx="145" cy="35" r="7" className="fill-bg-secondary" />
                <circle cx="134" cy="8" r="4" className="fill-bg-secondary" />
                <circle cx="76" cy="52" r="52" className="fill-bg-secondary" />
                <g filter="url(#credit-card-shadow-sm)">
                    ...
                    />
                    <circle cx="114.667" cy="32.3335" r="8.33333" className="fill-border-secondary" />
                    <circle cx="104.667" cy="32.3333" r="8.33333" className="fill-bg-tertiary" />
                    <path
...
export const md = ({
    ...
    return (
        <div {...otherProps} className={cn("relative h-35.75 w-45", className)}>
            <svg viewBox="0 0 180 143" fill="none" className={cn("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="90" cy="64" r="64" className="fill-bg-secondary" />
                <circle cx="24" cy="6" r="6" className="fill-bg-secondary" />
                <circle cx="21" cy="112" r="8" className="fill-bg-secondary" />
                <circle cx="164" cy="36" r="8" className="fill-bg-secondary" />
                <circle cx="153" cy="9" r="5" className="fill-bg-secondary" />
                <g filter="url(#credit-card-shadow-md)">
                    ...
                    <path
                        ...
                        className="fill-bg-tertiary"
                    />
                    <circle cx="137" cy="42" r="10" className="fill-border-secondary" />
                    <circle cx="125" cy="42" r="10" className="fill-bg-tertiary" />
                    <path
...
export const lg = ({
    ...
    return (
        <div {...otherProps} className={cn("relative h-41.75 w-55", className)}>
            <svg viewBox="0 0 220 167" fill="none" className={cn("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="110" cy="80" r="80" className="fill-bg-secondary" />
                <circle cx="18" cy="12" r="8" className="fill-bg-secondary" />
                <circle cx="198" cy="142" r="6" className="fill-bg-secondary" />
                <circle cx="25" cy="138" r="10" className="fill-bg-secondary" />
                <circle cx="210" cy="46" r="10" className="fill-bg-secondary" />
                <circle cx="191" cy="11" r="7" className="fill-bg-secondary" />
                <g filter="url(#credit-card-shadow-lg)">
                    ...
                    <path
                        ...
                        className="fill-bg-tertiary"
                    />
                    <circle cx="166.837" cy="53.4419" r="12.093" className="fill-border-secondary" />
                    <circle cx="152.325" cy="53.4419" r="12.093" className="fill-bg-tertiary" />
                    <path
