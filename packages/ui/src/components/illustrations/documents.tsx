 ...
 * Path: components/shared-assets/illustrations/documents.tsx
 *
...
export const sm = ({
    ...
    return (
        <div {...otherProps} className={cn("relative h-30 w-40.25", className)}>
            <svg viewBox="0 0 161 120" fill="none" className={cn("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="27" cy="11" r="5" className="fill-bg-secondary" />
                <circle cx="24" cy="109" r="7" className="fill-bg-secondary" />
                <circle cx="151" cy="35" r="7" className="fill-bg-secondary" />
                <circle cx="140" cy="8" r="4" className="fill-bg-secondary" />
                <circle cx="82" cy="52" r="52" className="fill-bg-secondary" />
                <g filter="url(#documents-shadow-01-sm)">
                    ...
                    <path
                        ...
                        strokeWidth="0.5"
                    />
                    <path d="M49.6569 12.2471L62.949 17.085L53.884 21.3121L49.6569 12.2471Z" className="fill-bg-tertiary" />
                </g>
                <g filter="url(#documents-shadow-02-sm)">
                    ...
                    <path
                        ...
                        strokeWidth="0.5"
                    />
                    <path d="M93.6226 8L103.625 18.0022H93.6226V8Z" className="fill-bg-tertiary" />
                </g>
                <g filter="url(#documents-shadow-03-sm)">
                    ...
                    <path
                        ...
                        strokeWidth="0.5"
                    />
                    <path d="M134.936 22.0903L139.774 35.3825L130.708 31.1554L134.936 22.0903Z" className="fill-bg-tertiary" />
                </g>
                ...
                <defs>
                    ...
                    <linearGradient id="documents-gradient-01-sm" x1="45.7739" y1="79.2399" x2="19.2854" y2="31.4527" gradientUnits="userSpaceOnUse">
                        <stop stopColor="currentColor" className="text-bg-secondary" />
                        <stop offset="1" stopColor="currentColor" className="text-bg" />
                    </linearGradient>
            ...
            {children && (
                <span
                    className={cn(
                        "absolute inset-x-13 bottom-2 z-10 flex size-12 items-center justify-center rounded-full bg-alpha-black/20 text-primary-fg backdrop-blur-xs",
                        childrenClassName,
                    )}
                >
                    {children}
...
export const md = ({
    ...
    return (
        <div {...otherProps} className={cn("relative h-34.25 w-46.25", className)}>
            <svg viewBox="0 0 185 137" fill="none" className={cn("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="95" cy="64" r="64" className="fill-bg-secondary" />
                <circle cx="29" cy="12" r="6" className="fill-bg-secondary" />
                <circle cx="26" cy="112" r="8" className="fill-bg-secondary" />
                <circle cx="173" cy="96" r="8" className="fill-bg-secondary" />
                <circle cx="158" cy="9" r="5" className="fill-bg-secondary" />
                <g filter="url(#documents-shadow-01-md)">
                    ...
                    <path
                        ...
                        strokeWidth="0.5"
                    />
                    <path d="M56.2523 15.0952L72.1994 20.8995L61.3237 25.9709L56.2523 15.0952Z" className="fill-bg-tertiary" />
                </g>
                <g filter="url(#documents-shadow-02-md)">
                    ...
                    <path
                        ...
                        strokeWidth="0.5"
                    />
                    <path d="M109 10L121 22H109V10Z" className="fill-bg-tertiary" />
                </g>
                <g filter="url(#documents-shadow-03-md)">
                    ...
                    <path
                        ...
                        strokeWidth="0.5"
                    />
                    <path d="M158.564 26.9048L164.369 42.8519L153.493 37.7805L158.564 26.9048Z" className="fill-bg-tertiary" />
                </g>
            ...
            {children && (
                <span
                    className={cn(
                        "absolute bottom-3 left-1/2 z-10 flex size-14 -translate-x-1/2 items-center justify-center rounded-full bg-alpha-black/20 text-primary-fg backdrop-blur-xs",
                        childrenClassName,
                    )}
                >
                    {children}
...
export const lg = ({
    ...
    return (
        <div {...otherProps} className={cn("relative h-41.5 w-57.5", className)}>
            <svg viewBox="0 0 230 166" fill="none" className={cn("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="118" cy="80" r="80" className="fill-bg-secondary" />
                <circle cx="34" cy="20" r="8" className="fill-bg-secondary" />
                <circle cx="206" cy="126" r="6" className="fill-bg-secondary" />
                <circle cx="33" cy="138" r="10" className="fill-bg-secondary" />
                <circle cx="218" cy="38" r="10" className="fill-bg-secondary" />
                <circle cx="199" cy="11" r="7" className="fill-bg-secondary" />
                <g filter="url(#documents-shadow-01-lg)">
                    ...
                    <path
                        ...
                        strokeWidth="0.5"
                    />
                    <path d="M67.123 18.7017L88.0984 26.3361L73.7935 33.0066L67.123 18.7017Z" className="fill-bg-tertiary" />
                </g>
                <g filter="url(#documents-shadow-02-lg)">
                    ...
                    <path
                        ...
                        strokeWidth="0.5"
                    />
                    <path d="M136.503 12L152.286 27.7837H136.503V12Z" className="fill-bg-tertiary" />
                </g>
                <g filter="url(#documents-shadow-03-lg)">
                    ...
                    <path
                        ...
                        strokeWidth="0.5"
                    />
                    <path d="M201.695 34.2349L209.329 55.2102L195.024 48.5398L201.695 34.2349Z" className="fill-bg-tertiary" />
                </g>
            ...
            {children && (
                <span
                    className={cn(
                        "absolute bottom-5 left-1/2 z-10 flex size-14 -translate-x-1/2 items-center justify-center rounded-full bg-alpha-black/20 text-primary-fg backdrop-blur-xs",
                        childrenClassName,
                    )}
                >
                    {children}
