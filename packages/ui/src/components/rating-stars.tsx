 ...
 * Path: components/foundations/rating-stars.tsx
 *
...
export const getStarProgress = (starPosition: number, rating: number, maxRating = 5) => {
...
export const StarIcon = ({ progress = 100, ...props }: StarIconProps) => {
  ...
  return (
    <svg
      ...
      aria-hidden="true"
      {...props}
      className={cn("size-5 text-yellow-400", props.className)} // dark-ok — rating star is iconic yellow in both modes
    >
      <path
